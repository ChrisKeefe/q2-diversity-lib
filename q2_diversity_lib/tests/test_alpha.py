...
class AlphaTests(TestCase):
    ...
    # TODO: Begin tests for faith_pd. These might be extensible to all
    # alpha_phylo metrics (should we implement additional metrics). A
    # generalized testing model should be used for all non-phylogenetic
    # measures if possible.

    # TODO: does it run and is it operating as expected
    ...
    def test_faith_pd_error_rewriting(self):
        ...
        with self.assertRaisesRegex(skbio.tree.MissingNodeError,
            ...
            faith_pd(table=t, phylogeny=tree)
    ...
    # TODO: Is there value in tests confirming citations exist?
